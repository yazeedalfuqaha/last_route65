            ...
            <div class="row">
                <div class="col-xl-6 col-md-8">
                    <ul class="fp__topbar_info d-flex flex-wrap">
                        <li><a href="#"><i class="fas fa-envelope"></i> restaurant@gmail.com</a>
                        </li>
                        <li><a href="callto:123456789"><i class="fas fa-phone-alt"></i> +(415) 555‑0132</a></li>
                    </ul>
                </div>
    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <span id="loggo"><img src="images/download__1_-removebg-preview.png" alt="FoodPark" class="logo"  ></span>
            </a>
                ...
                <ul class="navbar-nav m-auto">
                   ...
                   <li class="nav-item">
                              <form action="logout" method="POST">
                                 @csrf()
                              <button type="submit" class="btn btn-dark" id="logincss">Logout</a>
